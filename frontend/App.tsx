...
import { ArrowRight, CheckCircle, AlertTriangle, ShieldCheck, Eye, RefreshCw, Sun, Crop, Aperture, Stamp, Brain, Sparkles, BookOpen } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-8 relative">
        ...
        <div className="max-w-3xl w-full bg-white rounded-lg border-4 border-black shadow-retro-lg p-10 text-center space-y-8 animate-fade-in z-10">
          ...
          <button onClick={() => setStage('CERTIFICATION')} className="text-gray-500 hover:text-black font-mono text-sm underline uppercase">
